...
*/}}
{{- define "webapp-ingress.fullname" -}}
...
Common labels
*/}}
{{- define "webapp-ingress.labels" -}}
helm.sh/chart: {{ include "webapp-ingress.chart" . }}
{{ include "webapp-ingress.selectorLabels" . }}
{{- if .Chart.AppVersion }}
